...
public class AudioStreamPlayer {
	...
	private int getChunkPosition() {
		...
		if (chunkPositionClock != null) {
			...
			Logger.getLogger("JavaScriptPublicAPI").info(LogUtils.prefix("PLAYER INDEX GET: chunckpos1 " + this.id + " " + pos));
		}
		Logger.getLogger("JavaScriptPublicAPI").info(LogUtils.prefix("PLAYER INDEX GET: chunckpos2 " + this.id + " " + pos));
		return pos;
	}
