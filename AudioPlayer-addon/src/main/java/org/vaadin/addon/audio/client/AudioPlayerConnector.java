...
public class AudioPlayerConnector extends AbstractExtensionConnector {
	...
	Timer reportPositionTimer = null;
	...
	protected void extend(ServerConnector target) {
    	...
    	reportPositionTimer = new Timer() {
			@Override
			public void run() {
			      if(player != null){
                    Log.message(this, " last playback position player id" + player.id);
	...
	public void onUnregister() {
	    if(reportPositionTimer != null){
	        reportPositionTimer.cancel();
